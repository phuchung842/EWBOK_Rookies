...
namespace Common
{
    ...
    {
        public static string TYPE_BANNER = "TYPE_BANNER";
        public static string TYPE_BANNER_ID = "TYPE_BANNER_ID";
        public static string TYPE_BANNER_BRAND = "TYPE_BANNER_BRAND";
